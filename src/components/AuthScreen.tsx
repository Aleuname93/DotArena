    ...
    <div className="crt min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center p-6 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm flex flex-col items-center gap-8">
        ...
        <div className="w-full bg-black p-7"
          ...
          {step === 'loading' && (
            <p className="text-[#00ff41] text-[8px] font-pixel text-center py-6 pixel-blink">LOADING...</p>
          )}

          {step === 'needs_name' && (
            <>
              <p className="text-[#ffdd00] text-[8px] font-pixel mb-1 text-center pixel-blink">★ WELCOME! ★</p>
              <p className="text-white/30 text-[7px] font-pixel mb-6 text-center">CHOOSE YOUR NAME</p>
